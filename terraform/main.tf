...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "Reconciliation Engine • Collateral (Corporate Banking)"
    environment = "production"
    Name = "agentbridge-reconciliation-engine---collateral--corp"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-reconciliation-engine---collateral--corp-igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-reconciliation-engine---collateral--corp-public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-reconciliation-engine---collateral--corp-rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-reconciliation-engine---collateral--corp-"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-reconciliation-engine---collateral--corp-sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-reconciliation-engine---collateral--corp"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-reconciliation-engine---collateral--corp-eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-reconciliation-engine---collateral--corp-data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-reconciliation-engine---collateral--corp-bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-reconciliation-engine---collateral--corp-ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-reconciliation-engine---collateral--corp-ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-reconciliation-engine---collateral--corp-flow"
